...
<template>
    <v-card variant="outlined" class="rounded card-hover overflow-hidden">
        <NuxtLink :to="`/apps/ecommerce/product/detail/${goto}`" class="overflow-hidden d-block lh-0"> 
        ...
        <v-card-item class="pa-6 pt-1">
            ...
            <div class="d-flex align-center justify-space-between mt-2">
                ...
                <ClientOnly><v-rating color="warning" half-increments size="small" density="compact" v-model="rate" > </v-rating></ClientOnly>
            </div>
        </v-card-item>
