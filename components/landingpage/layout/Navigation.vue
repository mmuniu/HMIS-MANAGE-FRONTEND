...
import AppsLink from '@/components/lc/Full/vertical-header/AppsLink.vue';
...
<template>
    ...
    <v-menu open-on-hover :close-on-content-click="false" class="lp_wrapper position-relative">
        ...
        <v-sheet max-width="100%" width="1150" height="100%"  rounded="md" class="pa-8 mx-auto elevation-dropdown">
            ...
            <div>
                <v-row>
                    ...
                    <v-col cols="12" md="4" class="pa-0">
                        <img src="/images/backgrounds/mega-dd-bg.jpg" alt="matdash-img" height="320" class="w-100" />
                    </v-col>
                </v-row>
            </div>
        </v-sheet>
    ...
    <v-btn
        ...
        href="https://adminmart.github.io/premium-documentation/nuxt/matdash/index.html"
        target="_blank"
        >Documentation</v-btn
    >
