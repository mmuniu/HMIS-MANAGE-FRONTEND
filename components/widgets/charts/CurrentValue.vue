...
const chartOptions3 = computed(() => {
    return {
        ...
        colors: ['rgba(var(--v-theme-primary))', 'rgba(var(--v-theme-light))', 'rgba(var(--v-theme-secondary))'],
        plotOptions: {
            pie: {
                startAngle: 0,
                endAngle: 360,
            ...
            <v-row class="mt-4 mb-1">
                ...
                <v-col cols="12" sm="4">
                    <v-card variant="outlined" >
                        <v-card-item>
                            <ClientOnly><apexchart type="bar" height="200" :options="chartOptions" :series="Chart"> </apexchart></ClientOnly>
                ...
                <v-col cols="12" sm="4">
                    <v-card variant="outlined" >
                        <v-card-item>
                            <ClientOnly><apexchart type="bar" height="200" :options="chartOptions2" :series="Chart2"> </apexchart></ClientOnly>
                ...
                <v-col cols="12" sm="4">
                    <v-card variant="outlined" >
                        <v-card-item>
                            <ClientOnly><apexchart class="mb-5" type="donut" height="180" :options="chartOptions3" :series="Chart3"> </apexchart></ClientOnly>
