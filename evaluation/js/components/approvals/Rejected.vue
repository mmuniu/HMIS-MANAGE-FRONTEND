<template>
    <div>
        <collabmed-loading v-if="!initialised" type="dna"></collabmed-loading>

        <div v-else>
            <h4 class="subheadline font-weight-light">Rejected</h4>

            <v-data-table :headers="headers" :items="list.data"
    ...
    data() {
        return {
            ...
            headers: [
                ...
                { text: 'Rejected by:', value: 'rejectors' },
                { text: 'Initial Price:', value: 'initial price' },
                { text: 'Initial Amount:', value: 'initial amount' },
