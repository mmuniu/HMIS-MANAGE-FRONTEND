<template>
    <div>
        <h5 class="headline" style="font-weight: bold; text-decoration: underline">OP Notes</h5>
...
export default {
    ...
    computed: {
        list() {
            ...
            notes.push({ 'name': 'Recorded On', 'value': this.items.created_at });
            notes.push({ 'name': 'Recorded By', 'value': this.items.user ? this.items.user.full_name : '-' });
