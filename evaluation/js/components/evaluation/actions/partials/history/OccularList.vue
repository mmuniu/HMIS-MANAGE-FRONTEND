  ...
  <div class="px-2">
    <v-container fluid class="px-5">
      <v-row >
        ...
        <v-col cols="12" sm="9">
          <op-notes :items="history?.doctorsNotes?.[0] || {}"></op-notes>
        </v-col>
        <v-col cols="12" sm="9">
...
import Visit from './OccularVisit';
import OutpatientNotes from './OccularOutpatientNotes';
// import InpatientNotes from "./InpatientNotes";
import OpNotes from './OccularOPNotes';
...
import Prints from './OccularPrints';
