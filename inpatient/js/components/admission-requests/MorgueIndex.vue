          ...
          <v-card-text>
              ...
              <div v-if="list && list.data">
                ...
                <template v-slot:item.actions="{ item }">
                  <v-btn small color="pink"
                  @click="authorize(item)" :loading="saveLoader">Authorize</v-btn>
                  ...
                  :loading="saveLoader">Payment Mode</v-btn>


                  <v-btn small
                  color="blue"
                  :href="admit(item)">Admit</v-btn>
...
export default {
  ...
  computed: {
      ...
      initialised() {
        ...
        return this.fetchAndDisplayPatients();
