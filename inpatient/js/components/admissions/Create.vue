                ...
                <v-card class="ml-2">
                    ...
                    <v-card-text>
                        ...
                        <div v-else>
                            ...
                            <v-btn block dark color="primary" class="mt-12" :loading="saveLoader" @click="readmit()">
                              Readmit Patient
                            ...
                            <v-row class="px-3"  >
                                ...
                                <v-col cols="6" v-if="msetting('inpatient.auto_generate_inpatient_no')">
                                            <v-text-field
                                                    v-model="obj.admission.inpatient_no"
                                                    class="mr-2"
                                                    label="Re-admission IP No( Leave blank for new patients)"
                                                    hint="Enter for patients with existing file"
                                            ></v-text-field>
                                        </v-col>
...
export default {
    ...
    methods: {
        ...
        readmit()
        {
          fetch('/api/settings/save/settings/', {
          method: 'POST',
          headers: {
