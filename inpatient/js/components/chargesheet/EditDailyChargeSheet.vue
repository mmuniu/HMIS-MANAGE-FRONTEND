            ...
            <div v-for="(dateCharges, date) in charges.data" :key="date" class="px-4 py-2">
                ...
                <div>
                    <div>
                        ...
                        <p class="display-inline headers" style="width: 10%">Name</p>
                        <p class="display-inline headers" style="width: 10%">Type</p>
                        <p class="display-inline headers" style="width: 10%">Location</p>
                        <p class="display-inline headers" style="width: 12%">Units</p>
                        <p class="display-inline headers" style="width: 14%">Price</p>
                        <p class="display-inline headers" style="width: 10%">Total</p>
                        <p class="display-inline headers" style="width: 7%">Inv/Rct status</p>
                        <p class="display-inline headers" style="width: 10%">Date</p>
                    </div>
                </div>
                ...
                <div v-for="(charge, index) in dateCharges" :key="index">
                    <div class="lighten-4"
                        ...
                        <p class="display-inline" style="width: 10%">{{ charge.name }}</p>
                        <p class="display-inline" style="width: 10%">{{ charge.type }}</p>
                        <p class="display-inline" style="width: 10%">{{ charge.treatment_location }}</p>
                        <p class="display-inline" style="width: 12%">
                        ...
                        <p class="display-inline" style="width: 14%">
                        ...
                        <p class="display-inline" style="width: 10%">{{ charge.total }}</p>
                        <p class="display-inline" style="width: 7%">
                            <span v-if="charge.paid === 'invoiced'">
                                <v-icon small color="success" style="cursor: default">
                                    check_circle
                                </v-icon>
                            </span>
                            
                            <span v-else>
                                <v-icon small color="error" style="cursor: default">
                                    cancel
                                </v-icon>
                            </span>
                            
                          </p>
                        <p class="display-inline" style="width: 10%">{{ charge.date }}</p>
                        <p class="display-inline" style="width: 10%" v-if="can('inpatient.remove-items-from-chargesheet')">
