...
<template>
    <v-card class="grey lighten-3">
        <v-card-title primary-title>
            <h5 class="font-weight-bold font-weight-thin headline">Changes - {{ item.procedures ? item.procedures.name : item.procedure }}</h5></v-card-title>
        <v-card-text>
            <v-data-table
                    :items="changes"
                    :headers="headers"
                    class="" flathide-default-footer
            >
