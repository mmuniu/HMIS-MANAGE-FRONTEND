...
export default class PosSetup extends Base {
    ...
    savePosDetails() {
        ...
        this.form.submit("post", route("api.inventory.setup.points-of-sale.store"), data).then((response) => {
            flash(response);
    ...
    updatePosDetails() {
        ...
        this.form.submit("patch", route("api.inventory.setup.points-of-sale.update", this.id), data).then((response) => {
            flash(response);
