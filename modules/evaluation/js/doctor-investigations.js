...
$(function () {
    ...
    $('#investigations_form input, #investigations_form textarea').blur(function () {
    ...
    $('#investigations_form').find('input').on('ifChanged', function () {
    ...
    $('#saveDiagnosis').click(function (e) {
        ...
        let formData = $('#radiology_form,#diagnosis_form, #laboratory_form').serialize();
