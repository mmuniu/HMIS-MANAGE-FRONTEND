...
$(document).ready(function () {
    ...
    $("#add_row").click(function () {
        var to_add = "<td><select name=\"item" + i + "\" class=\" select2-single\" style=\"width: 100%\"></select></td><td><input type=\"text\" name='qty" + i + "' placeholder='Quantity' value=\"1\"/></td><td><input type=\"text\" name='price" + i + "' placeholder='Price'/></td><td><span id=\"total" + i + "\">0.00</span></td><td><button class=\"btn btn-xs btn-danger remove\"><i class=\"fa fa-trash-o\"></i></button></td>";
        $('#addr' + i).html(to_add);
