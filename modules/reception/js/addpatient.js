...
$(document).ready(function () {
    ...
    function apply_schemes(that) {
        ...
        // $("select[name=insurance[" + id + "][scheme]").empty();
    ...
    var html_template = $('#wrapper0').html();
    $(add_button).click(function (e) { //on add input button click

        $(".insurance-wrapper").each(function(){
    ...
    $('form').submit(function (e) {
        ...
        form.append($(input));
        var update_photo = $("<input>")
            .attr("type", "hidden")
            .attr("name", "update_photo").val(1);
        form.append($(update_photo));
    });
