<template>
    ...
    <div>
        ...
        <!--    authorize modal -->
        <authorize :show="dialog"
            :item-id="selected.id"
            :required-amount="selected.authorization.amount"
            v-if="selected"
...
export default {
    ...
    methods: {
        ...
        saveAuthorization (data) {
            this.obj.authorization.authorized = data.authorized_amount;
            this.obj.authorization.admission_request_id = data.item_id;
            this.obj.authorization.required_amount = data.required_amount;
        ...
        admit(item) {
            if(this.morgue) {
                return route("morgue.admissions.store", item.id).relative();
            } else {
