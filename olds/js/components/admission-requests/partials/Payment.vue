...
<template>
    <v-dialog v-model="dialog" width="50%" persistent>
        ...
        <v-card>
            <v-card-title class="headline  white--text primary" primary-title height="50">
            ...
            <v-card-text  class="px-2 mt-3">
                <v-btn small color="primary" @click="payment_mode = 'cash'">Cash</v-btn>
                <v-btn small color="primary" @click="payment_mode = 'insurance'">Insurance Cover</v-btn>
                <v-container fluid v-if="payment_mode === 'cash'" class="mt-3">
                    <v-row >
                        <v-col>
