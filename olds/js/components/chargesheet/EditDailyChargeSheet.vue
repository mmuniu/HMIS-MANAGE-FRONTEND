...
<!--                            </v-list-item>-->
                            <v-list-item>
                                <v-btn color="success" small dark @click="printDailyChargeSheet(0, true)">
                ...
                <v-col class="text-right" cols="12" md="2">
                    <v-btn small color="primary" @click="processInpatientBill()">Process invoices</v-btn>
                </v-col>
            </v-row>
...
export default {
    ...
    computed: {
        ...
        morgue () {
            return this.$route.query.morgue ? true : false;
        }
    },
    ...
    methods: {
        ...
        printDailyChargeSheet(grouped = 0, departmental = false) {
            ...
            const departmentalPrint = departmental ? '&departmental=1' : '';

            const use_org = this.use_org ? '&use_org=1' : '&use_org=0';

            window.open(main_url + group + use_org + departmentalPrint, '_blank');
        },
