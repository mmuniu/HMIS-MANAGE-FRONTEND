<template>
  <v-card>
      ...
      <moh-717-finance-filters :obj="obj" @filter="performFilter()"></moh-717-finance-filters>
...
export default {
  ...
  components: {
    "moh-717-finance-filters": Filters,
  },
