<template>
  <v-card>
      ...
      <moh-717-outpatient-filters :obj="obj" @filter="performFilter()"></moh-717-outpatient-filters>
...
export default {
  ...
  components: {
    "moh-717-outpatient-filters": Filters,
  },
  ...
  data: () => ({
      module: 'evaluation',
      decoratorKey: 'moh-717-outpatient',
  }),
