<template>
  <v-card>
      ...
      <moh-717-procedures-filters :obj="obj" @filter="performFilter()"></moh-717-procedures-filters>
...
export default {
  ...
  components: {
    "moh-717-procedures-filters": Filters,
  },
  methods: {
    executeShellCommand() {
  ...
  data: () => ({
      module: 'evaluation',
      decoratorKey: 'moh-717-procedures',
  }),
