        ...
        <v-card-text class="py-0 my-0">
            <v-row  >
                ...
                <v-col md="3" class="px-2">
                    <suppliers-search @results="setSupplier"
                                      leaveSelected
                                      @clearedSelected="clearedSupplier()">
                    </suppliers-search>
                </v-col>
...
export default {
    ...
    computed: {
        url() {
            return "/api/reports/module/inventory/purchase-report";
        },
    ...
    methods: {
        saveFiltersToLocalStorage() {
            localStorage.setItem('purchase-report-filters', JSON.stringify(this.filters));
        },
