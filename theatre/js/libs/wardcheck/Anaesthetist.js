...
import { fields } from "./AnaesthetistRepository";
...
export default class AnaesthetistCheck extends Base {
    ...
    save() {
        ...
        this.form.submit("post", route("api.theatre.anaesthetist.check.store", [this.visit_id, "nurse", this.requested_facility_id]).relative(), data).then((response) => {
          alert(response);
