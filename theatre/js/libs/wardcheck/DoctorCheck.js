...
import { fields } from "./DoctorRepository";
import _ from "lodash";


export default class DoctorCheck extends Base {
    constructor() {
        super(fields);
    ...
    save() {
        ...
        this.form.submit("post", route("api.theatre.doctor.check.store", [this.visit_id, "nurse", this.requested_facility_id]).relative(), data).then((response) => {
          alert(response);
